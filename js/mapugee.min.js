...
/*! mapugee 2014-02-17 */
var Mapugee=function(a){"use strict";var b,c,d,e,f=$(document).width(),g=$(document).height(),h={state:"azimuthal",azimuthal:d3.geo.azimuthalEquidistant().scale(190*(g/400)).rotate([0,0]).clipAngle(179.999).translate([f/2,g/2]).precision(.1),mercator:d3.geo.mercator().scale(190*(g/400)).translate([f/2,g/2]).precision(.1),conic:d3.geo.conicEquidistant().scale(190*(g/400)).translate([f/2,g/2]).precision(.1)},i=d3.geo.path().projection(h[h.state]),j=d3.select(a).insert("svg",".shadow").attr("width",f).attr("height",g),k=j.append("g"),l="http://mapugee.boeppe.eu/data/dbrequest.php",m=.2,n=1.6,o=2012,p={},q={},r=1,s="cofr",t=0,u=1e7,v="AL",w=[{t:10,v:1},{t:10,v:2},{t:100,v:4},{t:1e3,v:6},{t:1e4,v:8},{t:1e5,v:10}],x=[{t:10,v:1},{t:10,v:1},{t:100,v:.9},{t:1e3,v:.85},{t:1e4,v:.8},{t:1e5,v:.75}],y=[{t:10,v:1.2},{t:10,v:1},{t:100,v:.8},{t:1e3,v:.6},{t:1e4,v:.4},{t:1e5,v:.2}];$(window).resize(function(){f=$(document).width(),g=$(document).height(),j.attr("width",f).attr("height",g),j.selectAll("path").attr("d",i.projection(h[h.state].scale(190*(g/600)).translate([f/2,g/2]))),H(),I()}),$("#mode-cofo").hide(),d3.json("data/world.json",function(a,b){var c=topojson.object(b,b.objects.countries).geometries,d=k.insert("g",".graticule").selectAll("path").data(c).enter().append("path").attr("d",i).attr("class","country").on("click",M).on("mouseover",U).on("mouseout",V);W(d)});var z=$(".loader_container");z.hide(),k.insert("path").datum(d3.geo.graticule()).attr("class","graticule").attr("d",i);var A=d3.behavior.zoom().scaleExtent([m,n]).on("zoom",function(){r=A.scale(),k.attr("transform","translate("+d3.event.translate.join(",")+")scale("+d3.event.scale+")"),k.selectAll("path"),k.selectAll("text"),b.makeLegend(r)});j.call(A);var B=function(a,b){z.fadeIn();for(var c=2001;2013>c;c+=1)$.getJSON(l+"?year="+c+"&"+b+"="+a+"&continent="+v,function(b){var c,d={};$.each(b.features,function(b,e){var f=[e.geometry.coordinates[0],e.geometry.coordinates[1]],g=parseInt(e.properties.total_pop),h=e.properties.code;d[h]={code:h,xy:f,linestyle:nb(g),total_ref:g,width:ob(g,w),opacity:ob(g,x),color:"hsl(34, 75%, "+Math.round(63*ob(g,y))+"%)"},"-1"===g?g="confidential":g+=" persons",d[h].title="cofo"===s?_countryNames[a]+" >> "+_countryNames[h]+"("+groupNumber(g)+")":_countryNames[h]+" >> "+_countryNames[a]+" ("+groupNumber(g)+")",e.properties.code===a&&(c=e.properties.total_pop)}),F(a,c,d)}).error(function(){z.fadeOut(),c-1===o&&alert("Error: Could not connect to database.")}).done(function(){z.fadeOut(),E(d,o)})},C=function(){return jQuery.isEmptyObject(p)?!1:!0},D=function(){p={},q={}},E=function(a,b){void 0!==p[b]&&G(p[b].arrows)},F=function(a,b,c){var d=0;$.each(c,function(b,c){b!==a&&c.total_ref>=0&&(d+=c.total_ref)}),q[b]=d,p[b]={coiCode:a,arrows:c}},G=function(a){var b=function(a){var b=[];for(var c in a)a.hasOwnProperty(c)&&b.push({key:c,value:a[c]});return b.sort(function(a,b){return b.value.width-a.value.width}),b};$.each(b(a),function(b,c){var e=c.value,f={type:"LineString",coordinates:[a[d].xy,e.xy],destCode:c.key,width:e.width};(e.total_ref>t&&e.total_ref<u||-1===e.total_ref)&&k.insert("path").datum(f).attr("d",i).attr("class","route").attr("propOpacity",e.opacity).attr("propWidth",e.width).on("mouseover",S).on("mouseout",T).on("click",_).attr({stroke:e.color,"stroke-width":e.width+"px",fill:"none","stroke-dasharray":e.linestyle}).append("title").text(e.title)}),eb(),Y(d,"country-highlight"),Z(a),bb()},H=function(){cb(),X()},I=function(){db(),X(),C()?E(d,o):(J(d),B(d,s,!0))},J=function(a){$.getJSON(l+"?country="+a,function(a){var b;$.each(a.features,function(a,c){b={x:c.geometry.coordinates[0],y:c.geometry.coordinates[1]}}),K(b.x,b.y)})},K=function(a,b){var c=h[h.state];i.projection(c.rotate([-a,-b])),j.selectAll("path").transition().duration(200).attr("d",i),z.fadeOut()},L=function(a){i=d3.geo.path().projection(h[a]),h.state=a,J(d),j.selectAll("path").transition.attr("d",i)},M=function(){N(d3.select(this).data()[0].id)},N=function(a){b.stopAnimation(),b.domObjects.boxArrowStats.hide("blind",300),H(),jb(a),C()&&D(),I()},O=function(){"cofr"===s?(s="cofo",R("cofr")):(s="cofr",R("cofo")),C()&&(D(),H(),B(d,s,!0))},P=function(){b.domObjects.timeControl.show()},Q=function(){b.domObjects.timeControl.hide()},R=function(){var a=$(".mode-toggle:hidden");$(".mode-toggle:visible").hide(),a.show()},S=function(){b.isPlaying()||(d3.selectAll(".route").transition().duration(200).style("stroke-opacity",.15),d3.select(this).transition().duration(200).style("stroke","#3D8DB6").style("stroke-opacity",1))},T=function(){b.isPlaying()||d3.selectAll(".route").each(function(){d3.select(this).transition().duration(200).style("stroke-opacity",d3.select(this).attr("propOpacity")).style("stroke",d3.select(this).attr("propColor"))})},U=function(){d3.select(this).attr("highlighted")||d3.select(this).attr("class","country-hover")},V=function(){d3.select(this).attr("highlighted")||d3.select(this).attr("class","country")},W=function(a){c=a},X=function(){d3.selectAll(".country-highlight-2").transition().duration(350).style("opacity",.8).attr("class","country").attr("highlighted",null),d3.selectAll(".country-highlight").transition().duration(350).style("opacity",.8).attr("class","country").attr("highlighted",null)},Y=function(a,b){c.filter(function(b){return b.id===a}).transition().duration(350).style("opacity",.6).attr("class",b).attr("highlighted",b)},Z=function(a){$.each(a,function(a){a!==d&&Y(a,"country-highlight-2")})},_=function(){e=d3.select(this).data()[0].destCode,ab()},ab=function(){var a=[],c=0;$.each(p,function(b,d){d.arrows.hasOwnProperty(e)?(c=d.arrows[e].total_ref,0>c&&(c=0),a.push(c)):a.push(0)}),b.domObjects.textPath.text("cofr"===s?"Refugees from "+_countryNames[e]+" to "+_countryNames[d]:"Refugees from "+_countryNames[d]+" to "+_countryNames[e]),b.uiChart.dropChart(".graphPath"),b.domObjects.boxArrowStats.show("blind",300),b.uiChart.draw(a,o,".graphPath",q)},bb=function(){var a,c=0;a="cofr"===s?"AL"!==v?"Refugees from "+_continentNames[v]+" to":"Refugees to":"AL"!==v?"Refugees to "+_continentNames[v]+" from":"Refugees from",b.uiChart.dropChart(".graphCountry"),b.domObjects.textMode.text(a),b.domObjects.textName.text(_countryNames[d]),b.domObjects.yearHud.is(":hidden")&&b.domObjects.yearHud.show(),b.domObjects.textYear.text(o),b.domObjects.yearHud.text(o),b.domObjects.selectCountry.val(_countryNames[d]),$.each(q,function(a,b){c+=parseInt(b)}),0!==c?(b.domObjects.textTotal.text("("+groupNumber(q[o])+")"),b.uiChart.draw(q,o,".graphCountry"),P()):(b.domObjects.textTotal.text("(no data)"),b.uiChart.dropChart(".graphCountry"),Q(),b.domObjects.yearHud.hide(),b.domObjects.boxArrowStats.hide("blind",300)),b.domObjects.boxArrowStats.is(":visible")&&ab()},cb=function(){d3.selectAll(".route").remove(),d3.selectAll(".toDelete").remove(),d3.selectAll(".route-hover").remove()},db=function(){d3.selectAll(".route").attr("class",".toDelete").transition().duration(400).style("stroke-opacity",0).each(function(){d3.select(this).remove()})},eb=function(){d3.selectAll(".toDelete").remove(),d3.selectAll(".route").each(function(){d3.select(this).transition().duration(300).style("stroke-opacity",d3.select(this).attr("propOpacity"))})},fb=function(a){o=a},gb=function(a){t=a,I()},hb=function(a){u=a,I()},ib=function(a){v=a,N(d)},jb=function(a){d=a},kb=function(a){b=a},lb=function(){return o},mb=function(){return{opacity:x,width:w,color:y}},nb=function(a){switch(!0){case 0>=a:return"5,5";default:return""}},ob=function(a,b){switch(!0){case a<=b[0].t:return b[0].v;case a>b[5].t:return b[5].v;case a>b[4].t:return b[4].v;case a>b[3].t:return b[3].v;case a>b[2].t:return b[2].v;case a>b[1].t:return b[1].v}};return{selectNewCountry:N,drawFlowMap:I,setProjection:L,setYear:fb,setFilterMin:gb,setFilterMax:hb,setContinent:ib,getYear:lb,getStyle:mb,toggleMode:O,setUi:kb}};_countryNames={ABW:"Aruba",AFG:"Afghanistan",AGO:"Angola",AIA:"Anguilla",ALB:"Albania",ALD:"Aland",AND:"Andorra",ARE:"United Arab Emirates",ARG:"Argentina",ARM:"Armenia",ASM:"American Samoa",ATA:"Antarctica",ATC:"Ashmore and Cartier Islands",ATF:"French Southern and Antarctic Lands",ATG:"Antigua and Barbuda",AUS:"Australia",AUT:"Austria",AZE:"Azerbaijan",BDI:"Burundi",BEL:"Belgium",BEN:"Benin",BFA:"Burkina Faso",BGD:"Bangladesh",BGR:"Bulgaria",BHR:"Bahrain",BHS:"The Bahamas",BIH:"Bosnia and Herzegovina",BLM:"Saint Barthelemy",BLR:"Belarus",BLZ:"Belize",BMU:"Bermuda",BOL:"Bolivia",BRA:"Brazil",BRB:"Barbados",BRN:"Brunei",BTN:"Bhutan",BWA:"Botswana",CAF:"Central African Republic",CAN:"Canada",CHE:"Switzerland",CHL:"Chile",CHN:"China",CIV:"Ivory Coast",CMR:"Cameroon",COD:"Democratic Republic of the Congo",COG:"Republic of Congo",COK:"Cook Islands",COL:"Colombia",COM:"Comoros",CPV:"Cape Verde",CRI:"Costa Rica",CUB:"Cuba",CYM:"Cayman Islands",CYN:"Northern Cyprus",CYP:"Cyprus",CZE:"Czech Republic",DEU:"Germany",DJI:"Djibouti",DMA:"Dominica",DNK:"Denmark",DOM:"Dominican Republic",DZA:"Algeria",ECU:"Ecuador",EGY:"Egypt",ERI:"Eritrea",ESP:"Spain",EST:"Estonia",ETH:"Ethiopia",FIN:"Finland",FJI:"Fiji",FLK:"Falkland Islands",FRA:"France",FRO:"Faroe Islands",FSM:"Federated States of Micronesia",GAB:"Gabon",GBR:"United Kingdom",GEO:"Georgia",GGY:"Guernsey",GHA:"Ghana",GIN:"Guinea",GMB:"Gambia",GNB:"Guinea Bissau",GNQ:"Equatorial Guinea",GRC:"Greece",GRD:"Grenada",GRL:"Greenland",GTM:"Guatemala",GUM:"Guam",GUY:"Guyana",HKG:"Hong Kong S.A.R.",HMD:"Heard Island and McDonald Islands",HND:"Honduras",HRV:"Croatia",HTI:"Haiti",HUN:"Hungary",IDN:"Indonesia",IMN:"Isle of Man",IND:"India",IOA:"Indian Ocean Territories",IOT:"British Indian Ocean Territory",IRL:"Ireland",IRN:"Iran",IRQ:"Iraq",ISL:"Iceland",ISR:"Israel",ITA:"Italy",JAM:"Jamaica",JEY:"Jersey",JOR:"Jordan",JPN:"Japan",KAS:"Siachen Glacier",KAZ:"Kazakhstan",KEN:"Kenya",KGZ:"Kyrgyzstan",KHM:"Cambodia",KIR:"Kiribati",KNA:"Saint Kitts and Nevis",KOR:"South Korea",KOS:"Kosovo",KWT:"Kuwait",LAO:"Laos",LBN:"Lebanon",LBR:"Liberia",LBY:"Libya",LCA:"Saint Lucia",LIE:"Liechtenstein",LKA:"Sri Lanka",LSO:"Lesotho",LTU:"Lithuania",LUX:"Luxembourg",LVA:"Latvia",MAC:"Macao S.A.R",MAF:"Saint Martin",MAR:"Morocco",MCO:"Monaco",MDA:"Moldova",MDG:"Madagascar",MDV:"Maldives",MEX:"Mexico",MHL:"Marshall Islands",MKD:"Macedonia",MLI:"Mali",MLT:"Malta",MMR:"Myanmar",MNE:"Montenegro",MNG:"Mongolia",MNP:"Northern Mariana Islands",MOZ:"Mozambique",MRT:"Mauritania",MSR:"Montserrat",MUS:"Mauritius",MWI:"Malawi",MYS:"Malaysia",NAM:"Namibia",NCL:"New Caledonia",NER:"Niger",NFK:"Norfolk Island",NGA:"Nigeria",NIC:"Nicaragua",NIU:"Niue",NLD:"Netherlands",NOR:"Norway",NPL:"Nepal",NRU:"Nauru",NZL:"New Zealand",OMN:"Oman",PAK:"Pakistan",PAN:"Panama",PCN:"Pitcairn Islands",PER:"Peru",PHL:"Philippines",PLW:"Palau",PNG:"Papua New Guinea",POL:"Poland",PRI:"Puerto Rico",PRK:"North Korea",PRT:"Portugal",PRY:"Paraguay",PSX:"Palestine",PYF:"French Polynesia",QAT:"Qatar",ROU:"Romania",RUS:"Russia",RWA:"Rwanda",SAH:"Western Sahara",SAU:"Saudi Arabia",SDN:"Sudan",SDS:"South Sudan",SEN:"Senegal",SGP:"Singapore",SGS:"South Georgia and South Sandwich Islands",SHN:"Saint Helena",SLB:"Solomon Islands",SLE:"Sierra Leone",SLV:"El Salvador",SMR:"San Marino",SOL:"Somaliland",SOM:"Somalia",SPM:"Saint Pierre and Miquelon",SRB:"Republic of Serbia",STP:"Sao Tome and Principe",SUR:"Suriname",SVK:"Slovakia",SVN:"Slovenia",SWE:"Sweden",SWZ:"Swaziland",SXM:"Sint Maarten",SYC:"Seychelles",SYR:"Syria",TCA:"Turks and Caicos Islands",TCD:"Chad",TGO:"Togo",THA:"Thailand",TJK:"Tajikistan",TKM:"Turkmenistan",TLS:"East Timor",TON:"Tonga",TTO:"Trinidad and Tobago",TUN:"Tunisia",TUR:"Turkey",TWN:"Taiwan",TZA:"United Republic of Tanzania",UGA:"Uganda",UKR:"Ukraine",URY:"Uruguay",USA:"United States of America",UZB:"Uzbekistan",VAT:"Vatican",VCT:"Saint Vincent and the Grenadines",VEN:"Venezuela",VGB:"British Virgin Islands",VIR:"United States Virgin Islands",VNM:"Vietnam",VUT:"Vanuatu",WLF:"Wallis and Futuna",WSM:"Samoa",YEM:"Yemen",ZAF:"South Africa",ZMB:"Zambia",ZWE:"Zimbabwe",CUW:"Curacao"},_continentNames={AF:"Africa",AN:"Antarctica",AS:"Asia",EU:"Europe",NA:"North America",OC:"Oceania",SA:"South America"};var MapugeeUiChart=function(){"use strict";var a=function(a,e,f){c();var g,h,i,j=370,k=150,l={value:[],globVal:[]};$.each(a,function(a,b){for(var c=b;-1!==jQuery.inArray(c,l.value);)c+=1;l.value.push(c)}),g=d3.scale.ordinal().domain(d3.range(l.value.length)).rangeRoundBands([0,j],.04),h=d3.scale.linear().domain([0,d3.max(l.value)]).range([0,k-25]),i=d3.select(f).append("svg").attr("width",j).attr("height",k),i.selectAll("rect").data(l.value,function(a){return a}).enter().append("rect").attr("x",function(a,b){return g(b)}).attr("y",function(a){return k-h(a)}).attr("width",g.rangeBand()).attr("height",function(a){return h(a)}).attr("fill",function(a){return"hsl(200, 50%, "+d(a,l.value)+"%)"}),i.selectAll("text").data(l.value,function(a){return a}).enter().append("text").text(function(a){return groupNumber(a)}).attr("text-anchor","middle").attr("x",function(a,b){return g(b)+g.rangeBand()/2}).attr("y",function(a){return k-h(a)-5}).attr("font-family","sans-serif").attr("font-size","7px").attr("fill","#666"),b(e)},b=function(a){var b=a-2e3;d3.selectAll(".hover").attr("class",""),d3.selectAll("rect:nth-child("+b+")").attr("class","hover")},c=function(a){$(a).empty()},d=function(a,b){Array.prototype.max=function(){return Math.max.apply(null,this)},Array.prototype.min=function(){return Math.min.apply(null,this)};var c=b.max();return 50-a/(c/30)};return{draw:a,hoverBar:b,dropChart:c}},MapugeeUi=function(a){"use strict";var b={timeControl:$(".timeControl"),textMode:$(".uiText.mode"),textName:$(".uiText.name"),textYear:$(".uiText.year"),textTotal:$(".uiText.total"),selectCountry:$(".selectCountry"),textPath:$(".migrationPath"),boxArrowStats:$(".arrowStats"),yearHud:$(".yearHud")};$(".mode-toggle").click(function(){a.toggleMode()}),$(function(){$(".mapControls").tabs()}),$(function(){$(".controlPanel").draggable()}),$(".controlPanelHeader .ui-icon").click(function(){$(".controls").is(":visible")?$(".controls").hide("blind",300,function(){$(".controlPanelHeader .ui-icon").removeClass("ui-icon-minus"),$(".controlPanelHeader .ui-icon").addClass("ui-icon-plus")}):$(".controls").show("blind",300,function(){$(".controlPanelHeader .ui-icon").removeClass("ui-icon-plus"),$(".controlPanelHeader .ui-icon").addClass("ui-icon-minus")})}),$(function(){var b=$.map(_countryNames,function(a,b){return{label:a,code:b}});$(".selectCountry").autocomplete({source:b,select:function(b,c){a.selectNewCountry(c.item.code)}})}),$(".selectCountry").click(function(){$(this).val("")}),$(function(){$(".yearSlider").slider({min:1,max:12,value:12,slide:function(b,c){var d=c.value+2e3;a.setYear(d),a.drawFlowMap(),j.hoverBar(d)}})});var c=500,d=!1,e=function(){d=!0,h()},f=function(){d=!1},g=function(){return d},h=function(){if(d){2012===a.getYear()&&a.setYear(2e3);var b=a.getYear()+1;a.setYear(b),a.drawFlowMap(),j.hoverBar(b),$(".yearSlider").slider({value:b-2e3}),setTimeout(function(){h()},c)}};$(".actrl.pause").click(f),$(".actrl.play").click(e),$(function(){$(".sliderSpeed").slider({orientation:"vertical",min:1,max:15,value:5,slide:function(a,b){c=1500-100*b.value}})});var i=function(b){var c=a.getStyle();$(".legend").empty();for(var d=0;d<c.width.length;d+=1){var e=groupNumber(c.width[d].t),f=Math.min(Math.max(Math.floor(b*c.width[d].v),1),20);e=0===d?"<= "+e:"> "+e,0===d&&$(".legend").append('<div class="floatBox legendBar" style="margin-top: 0.4em;border-bottom:1px dashed;border-color:hsl(34, 75%, '+Math.round(63*c.color[d].v)+'%);"></div><div class="floatBox legendBarText">(confidential)</div><div class="clearFloat"></div>'),$(".legend").append('<div style="height:'+f+'px;"><div class="floatBox legendBar" style="margin-top: 0.4'+d+"em;height:100%;background-color:hsl(34, 75%, "+Math.round(63*c.color[d].v)+'%);"></div><div class="floatBox legendBarText">'+e+'</div></div><div class="clearFloat"></div>')}};i(1),$(".filterSelect").change(function(){var b=$(".filterSelect option:selected").val();a.setFilterMin(0),a.setFilterMax(1e7),a.setFilterMin(b),"-1"===b?$(".customFilter").show():$(".customFilter").hide()}),$(".filterInputMin").focusout(function(){a.setFilterMin($(".filterInputMin").val())}),$(".filterInputMax").focusout(function(){a.setFilterMax($(".filterInputMax").val())}),$(".selectContinent").change(function(){a.setContinent($(".selectContinent option:selected").val())}),$(".selectProjection").change(function(){var b=$(".selectProjection option:selected").val();a.setProjection(b),f(),$(".projectionIcon").attr("src","img/icon-"+b+".png")});var j=new MapugeeUiChart;return $(".timeControl").hide(),$(".arrowStats").hide(),$(".yearHud").hide(),$(".customFilter").hide(),$(".closePathStats").click(function(){$(".arrowStats").hide("blind",300)}),{uiChart:j,stopAnimation:f,isPlaying:g,makeLegend:i,domObjects:b}};$(document).ready(function(){"use strict";var a=new Mapugee(".mapContainer"),b=new MapugeeUi(a);a.setUi(b)});var groupNumber=function(a){var b=parseInt(a).toString().split(".");return b[0].length>=4&&(b[0]=b[0].replace(/(\d)(?=(\d{3})+$)/g,"$1,")),b[1]&&b[1].length>=4&&(b[1]=b[1].replace(/(\d{3})/g,"$1 ")),b.join(".")};